...
public class HybridFileService : IHybridFileService
{
    ...
    public HybridFileService(IWebHostEnvironment env, ILogger<HybridFileService> logger)
    {
        ...
        // Given the workspace structure: /home/mickgreen58/git/aveva-ai-search-optimize/data/hybrid
        // And the app runs from: /home/mickgreen58/git/aveva-ai-search-optimize/src/BlazorApp
